<x-layout xmlns:x-slot="http://www.w3.org/1999/xhtml">
  ...
  <form action="" method="post" class="m-4">
    ...
    <div class="mb-3">
      ...
      <input class="form-control" type="number" min="0" max="99999999,99" step="0.01" id="price" name="price" value="{{ $product->price }}">
    </div>
    ...
    <div class="mb-3">
      ...
      <input class="form-control" type="number" min="0" max="99999999" step="1" id="quantity" name="quantity" value="{{ $product->quantity }}">
    </div>
